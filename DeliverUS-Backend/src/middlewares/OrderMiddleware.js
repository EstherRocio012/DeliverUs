...
// TODO: Implement the following function to check if the order belongs to current
// loggedIn customer (order.userId equals or not to req.user.id)
...
// TODO: Implement the following function to check if the restaurant of
// the order exists
